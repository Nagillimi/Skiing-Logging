...
class StatTests:
    ...
    @printTestResults
    @staticmethod
    def testContainsLocalPeak(x: np.ndarray, r: list, header=""):
    ...
    @printTestResults
    @staticmethod
    def testDecreasingTrend(x: np.ndarray, r: list, th=1, header=""):
    ...
    @printTestResults
    @staticmethod
    def testMinSampleCount(r: list, min_count=50, header=""):
        samples = r[1] - r[0]
    ...
    @printTestResults
    @staticmethod
    def testLowerSampleStdDev(x: np.ndarray, r: list, against_other_r=None, header=""):
    ...
    @printTestResults
    @staticmethod
    def testLargerSampleStdDev(x: np.ndarray, r: list, against_other_r=None, header=""):
    ...
    @printTestResults
    @staticmethod
    def testLowerSampleMean(x: np.ndarray, r: list, against_other_r=None, header=""):
    ...
    @printTestResults
    @staticmethod
    def testLargerSampleMean(x: np.ndarray, r: list, against_other_r=None, header=""):
    ...
    @printTestResults
    @staticmethod
    def testLargestMagnitude(x: np.ndarray, r: list, override_max=None, th=None, header=""):
    ...
    @printTestResults
    @staticmethod
    def testSmallestMagnitude(x: np.ndarray, r: list, th=None, header=""):
    ...
    @printTestResults
    @staticmethod
    def testTimingOfMagnitude(x: np.ndarray, r: list, th=None, header=""):
    ...
    @printTestResults
    @staticmethod
    def testRecentMax(x: np.ndarray, r: list, th=None, header=""):
        """tests the input `x` signal whether a large impulse occured close to the start of the landing range.
